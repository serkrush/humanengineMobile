...
export function entity<T extends {new(...args: any[]): {}}>(name: string, definitions: any = {}, options: any = {}) {
    return (constructor: T) => {
        return <any><any>class extends constructor {
            mEntityName = name;
            mSchema = [ new schema.Entity(name, definitions, options) ];
        };
    };
}
